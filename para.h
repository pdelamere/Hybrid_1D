...
c time stepping parameters
      PARAMETER (nt = 10)          !number of time steps
      ...
      PARAMETER (dt = 0.1*mproton/(q*b0_init))     !main time step
      PARAMETER (dtsub_init = dt/ntsub) !subcycle time step 
      PARAMETER (nout = 20)      !number of steps to diagnosic output 
