...
FILES = maind.f gutsf.f gutsp.f misc.f boundary.f part_init.f initial.f inputs.f global.f dimensions.f
INCLUDE = incurv.h para.h
OBJECTS = maind.o gutsf.o gutsp.o misc.o boundary.o part_init.o initial.o inputs.o global.o dimensions.o
